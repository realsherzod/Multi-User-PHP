                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h4 class="card-title mb-1">Please Sign in</h4>
                                <form autocomplete="off" class="auth-login-form mt-2"
                                    action="{{ request()->segment(2) == 'client' ? route('loginClient') : route('login') }}"
                                    method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-label" for="phone">Phone Number</label>
                                        <input class="form-control" id="phone" type="text" name="phone"
                                            placeholder="+998" aria-describedby="phone" autofocus=""
                                            tabindex="1" />
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a
                                        href="#"><span>&nbsp;Create an account</span></a></p>
